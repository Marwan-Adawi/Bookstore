        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/books" className="hover:text-indigo-600">All Books</Link></li>
              <li><Link href="/new-releases" className="hover:text-indigo-600">New Releases</Link></li>
              <li><Link href="/bestsellers" className="hover:text-indigo-600">Bestsellers</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/shipping" className="hover:text-indigo-600">Shipping Information</Link></li>
            </ul>
          </div>
          <div>
